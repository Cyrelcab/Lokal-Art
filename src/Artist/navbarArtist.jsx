...
export default function NavbarArtist({ fullName }) {
  ...
  return (
    <nav className="bg-white shadow-sm fixed top-0 w-full z-50">
      <div className="flex items-center justify-between px-8 py-4">
        ...
        <div className="hidden sm:flex flex-1 px-8 justify-center items-center">
          <ul className="flex justify-center space-x-14">
            ...
            <li>
              <Link to="/artist/transactions" className="text-black hover:text-cyan-500">
                My Transactions
              </Link>
            </li>
            <li>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="sm:hidden px-8 py-4 float-end">
