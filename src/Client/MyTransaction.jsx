    ...
    <div>
      ...
      <div className="mt-20 grid grid-cols-1">
        <div className="flex flex-col justify-center items-center">
          <div className="border-2 rounded-xl w-[40%] border-cyan-500">
            <h1 className="flex flex-col justify-center items-center text-xl text-cyan-400 font-bold py-5 border-b-2 border-cyan-500">
              Transaction Details
            </h1>
