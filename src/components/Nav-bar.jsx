...
export default function Navbar(){
    ...
    <nav className="h-20 font-bold flex justify-around shadow-md font-sans">
            ...
            <div className="flex justify-center items-center p-5">
                <a className="mr-10 hover:text-cyan-500 text-xl" href="#">Discover</a>
                <a className="mr-10 hover:text-cyan-500 text-xl" href="#">Transaction</a>
                <a className="hover:text-cyan-500 text-xl" href="#">Messages</a>
            </div>
